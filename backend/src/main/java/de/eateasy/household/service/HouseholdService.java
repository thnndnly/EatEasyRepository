...
public interface HouseholdService {
    ...
    /** Ändert Name oder default_diet_tags; nur OWNER. */
    ...
    /** Löst einen Token ein und macht den Aufrufer zum MEMBER. */
    ...
    /**
     * Prüfe stillschweigend, ob der User Mitglied des Haushalts ist. Wirft
     * keine Exception — für Auth-Checks in anderen Komponenten, die selbst
     ...
     * Wird z. B. von {@code RecipeService} für Sichtbarkeits-Queries genutzt.
     */
    List<UUID> listHouseholdIdsForUser(UUID userId);

    /**
     * Ob für den Haushalt das Auto-Nachbuchen aktiv ist. Ohne Auth-Check —
     ...
     * sonst in jeder fremden Komponente per Hand wiederholt würde.
     */
